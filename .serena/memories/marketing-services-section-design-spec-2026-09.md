...
- `Button variant="outline" size="sm"` + `LuArrowUpRight`
...
- Editorial header: 12-col, eyebrow mono `text-muted-foreground`, H2 `font-black`, lead right
- shadcn `Separator` + 2-column hairline grid, numbered 01–04, `Lu*` icons (no card shadows, no icon-circle)
