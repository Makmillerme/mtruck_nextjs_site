---
name: bot-engineer
description: Telegram Bot API / grammY specialist. Do NOT use in MTruck unless the user explicitly asks for a bot in this repo.
---

# Bot Engineer

**MTruck:** не застосовуй, поки користувач явно не попросить Telegram у цьому репо.
