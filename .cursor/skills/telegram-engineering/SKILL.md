...
description: Telegram standards (grammY, webhooks, Mini Apps). Do NOT use in MTruck unless the user explicitly asks for Telegram in this repo.
---

# Telegram Engineering

**MTruck:** цей репозиторій без Telegram. Не застосовуй цей skill і не скейфолдь бота, поки користувач явно не попросить.
